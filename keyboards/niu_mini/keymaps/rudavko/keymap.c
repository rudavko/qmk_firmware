...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(
    KC_GRV,   _______,  _______,  X_SCR3,   X_SCR4,   _______,  _______,  _______,  _______,  KC_MINS,  KC_EQL,   _______,
    _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_LCBR,  KC_LBRC,  KC_RCBR,  KC_RBRC,  KC_BSLS,
