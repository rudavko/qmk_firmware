...
#define SCR3 SGUI(KC_3)
#define SCR4 SGUI(KC_4)
#define SPCL1 LT(1, KC_SPC)
#define ENTL2 LT(1, KC_ENT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL,  MO(4),    KC_LALT, KC_LGUI,  SPCL1,     MO(1),    MO(2),    ENTL2,    KC_RGUI,  KC_RALT,  MO(3),    _______
   ),
	[1] = LAYOUT(
    KC_GRV,   _______,  _______,  SCR3,     SCR4,     _______,  _______,  _______,  _______,  _______,  _______,  _______,
